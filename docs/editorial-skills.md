...
Sources or disclosure decisions. All three review records must name the digest
of the current `article.md` and optional `sources.md`; an edit makes them stale.
